...
module.exports = (function() {
	...
	function Enemy(type, initialRound) {
		...
		this.hp = Util.randomRange(this._base.healthRange.min, this._base.healthRange.max);
	...
	Enemy.prototype.attack = function(options) {
		...
		return Util.randomRange(this._base.damageRange.min, this._base.damageRange.max);
	}
